...
public class EmailServiceImpl implements EmailService{
	...
	final String FROM = "dipayan1.das@gmail.com";

	// The subject line for the email.
	final String SUBJECT = "One last step to complete your registration with UserApp";
	...
	public void verifyEmail(String email,String verificationToken) {
		...
		String htmlBodyWithToken = HTMLBODY.replace("$tokenValue", verificationToken);
		String textBodyWithToken = TEXTBODY.replace("$tokenValue", verificationToken);
